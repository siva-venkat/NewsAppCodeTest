//
//  NewsAppCodeTestTests.swift
//  NewsAppCodeTestTests
//
//  Created by Sivaranjani Venkatesh on 24/1/22.
//

import XCTest
@testable import NewsAppCodeTest

class NewsAppCodeTestTests: XCTestCase {
